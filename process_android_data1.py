...
def process_pkl_gz_files(folder_path):
    ...
    for root, dirs, files in os.walk(folder_path):
        for dir in dirs:
            ...
            print(f'Now dir: {dir}, num of completed: {current_task}, num of trail: {len(agent2_data)}') 
            ...
            # filename_agent0 = 'android_world/training_data/UI_android_agent0.tsv'
            # filename_agent1 = 'android_world/training_data/UI_android_agent1.tsv'
            # filename_agent2 = 'android_world/training_data/UI_android_agent2.tsv'
...
# 统计每种 task_template 的出现次数
task_template_counts = Counter(task_completed)

# 转换为词典
task_template_counts_dict = dict(task_template_counts)

print('Statistics', task_template_counts_dict)