...
_TASK_RANDOM_SEED = flags.DEFINE_integer(
    ...
    #'task_random_seed', 47, 'Random seed for task randomness.'
    #'task_random_seed', 71, 'Random seed for task randomness.'
    'task_random_seed', 500, 'Random seed for task randomness.'
)
...
_OUTPUT_PATH = flags.DEFINE_string(
    'output_path', 
    os.path.expanduser('android_world/run_qwen_epo6'),
...
def _get_agent(
  ...
  # agent_group
    ...
    #agent_list = [('COT_LLM_zz', 0.3), ('COT_LLM_zz', 0.7), ('COT_LLM_zz', 1)]
    agent_list = [('COT_LLM_qwen', 0.0), ('COT_LLM_qwen', 0.5), ('COT_LLM_qwen', 0.8)]
    connection_pair = [(0,1), (0,2), (1,2)]
    #graph_agent = SimpleGraph(domain="android_world", model_name='gpt-4-turbo-2024-04-09')
    #graph_agent = SimpleGraph(domain="android_world", model_name='gpt-3.5-turbo-0125')
    #graph_agent = SimpleGraph(domain="android_world", model_name='gpt-3.5-turbo-1106')
    #graph_agent = SimpleGraph(domain="android_world", model_name='gpt-4o-2024-05-13')
    ...
    agent = t3a_3a.T3A(env, graph_agent)
